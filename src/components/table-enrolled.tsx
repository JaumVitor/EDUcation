...
export default function TableEnrolled() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      setStudents(data)
      setStudentsEnrolled(data.filter((student) => student.matricula === 'Matriculado'))
    }
    fetchData()
  }
  , [])
  ...
  const currentPosts = studentsEnrolled.slice(firstPostIndex, lastPostIndex)
  
  return (
    <div>
      <TabsContent className="mt-0" value="enrolled">
